...
use App\Modules\Reports\Infra\Database\Entity\AccumulatedEfficiencySevenDays;
...
class AccumulatedEfficiencySevenDaysController extends AbstractController implements TokenAuthenticatedController
{
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $repository = new Repository(AccumulatedEfficiencySevenDays::class, true);
